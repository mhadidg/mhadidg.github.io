...
Pragmatic software engineer with broad interests and unlimited curiosity. Self-studying business, economics, and AI
mastery for software development and agentic systems. Aspired to build my own business or co-found a great one.
...
comes from physical movement in nature is hard to find anywhere else.

[Reading books](https://www.goodreads.com/user/show/63237197) is my preferred way to learn big ideas, explore
interesting topics, and just expand my forever-shallow comprehension of the world; some of my favorites:

- *Design Patterns* (Gang of Four book). A foundational guide on solving common software design problems through
  language-agnostic patterns. Many believe it's outdated these days, but I disagree: the lessons there are timeless.
- *A Philosophy of Software Design*. The author, a well-respected computer scientist, argues that software design is
  primarily about managing complexity to keep systems understandable and maintainable over time.
